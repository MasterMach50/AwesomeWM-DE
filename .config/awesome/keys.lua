...
-- $$ |\$  /$$ |$$  __$$ | $$ |$$\ $$ |  $$ |$$   ____|$$ | $$ | $$ |
-- $$ | \_/ $$ |\$$$$$$$ | \$$$$  |$$ |  $$ |\$$$$$$$\ \$$$$$\$$$$  |
-- \__|     \__| \_______|  \____/ \__|  \__| \_______| \_____\____/ 
...
keys.globalkeys = gears.table.join(
    ...
    -- Open Apps
    awful.key({ superkey, altkey    }, "space", function() awful.spawn.with_shell("rofi -show run") end,
                {description = "open rofi", group = "custom"}),
    awful.key({}, "Print", function() awful.spawn.with_shell("gnome-screenshot") end,
                {description = "take screenshot with gnome-screenshot", group = "custom"}),
    -- Volume Controls
    awful.key({ superkey }, "Up", function() awful.spawn.with_shell("amixer -q sset Master 5%+") end,
            {description = "increase volume", group = "custom"}),
    awful.key({ superkey }, "Down", function() awful.spawn.with_shell("amixer -q sset Master 5%-") end,
